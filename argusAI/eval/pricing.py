...
# Placeholder defaults — override in config with real, current prices.
DEFAULT_PRICING: dict[str, ModelPrice] = {
    "gpt-5-mini": ModelPrice(input_per_1m=0.25, output_per_1m=2.00, cached_per_1m=0.025),
    "gpt-5-nano": ModelPrice(input_per_1m=0.05, output_per_1m=0.40, cached_per_1m=0.005),
    "gpt-5": ModelPrice(input_per_1m=1.25, output_per_1m=10.00, cached_per_1m=0.125),
    "gpt-5.5": ModelPrice(input_per_1m=2.00, output_per_1m=16.00, cached_per_1m=0.20),
