...
class Summarizer:
    def __init__(
        ...
        try:
            from openai import OpenAI  # noqa: PLC0415 - lazy: openai is an optional ('ai-eval') dependency
        except ImportError as exc:  # pragma: no cover - dependency guard
            raise SummarizerError(
                "The 'openai' package is required for summarization. "
                "Install it via the 'ai-eval' optional dependency group."
            ) from exc
